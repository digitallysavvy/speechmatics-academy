...
|-------------|---------|----------|-----------|
| <img src="integrations/agora/logo/agora-logo-rgb-blue.svg" alt="Agora" height="22"> | [Conversational AI Voice Agent](integrations/agora/01-conversational-ai-agent/) | RTC audio, RTM transcripts and state, managed voice agent, Speechmatics STT, LLM, TTS | Python |
